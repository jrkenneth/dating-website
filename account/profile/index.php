...
<small><i class='icon-lock'></i> Your <a href='#'>privacy</a> is important to us and we will never rent or sell your information.</small></strong></div>
			...
			$sqlnew = "select * from conversations where receiver='$mem_id' and status='1'"; 
						$resnew=mysqli_query($con,$sqlnew);
						$countnew = mysqli_num_rows($resnew);
			...
			$add_privy = "
						<div id='send-private-message' class='generic-button'>
                            <a class='has-tip tip-right send-message' data-width='350'
                               ...
                               href='../conversations/index.php'><img src='../../wp-content/convos.png' style='width: 40px; height: 40px;'> $countnew</a>
                        </div>
...
<head>
	...
	<title><?php echo $f_name." ".$m_name." ".$l_name; ?> &#8211; BEMYSPOUSE</title>
					...
					<div id="breadcrumbs-wrapp">
						<div class="row">
							<div class="nine columns">
								<ul class="breadcrumbs hide-for-small"><li><a href="../../index.php" title="Sweet Date" rel="home" class="trail-begin">Home</a>  </li><li><a href="index.php" title="<?php echo $f_name." ".$m_name." ".$l_name; ?>">My Profile</a>  </li></ul>							</div>
...
<div class="five columns">
    ...
    <h2><?php echo $f_name." ".$m_name." ".$l_name; ?></h2>
    <span class="user-nicename">@<?php echo $usn; ?></span>
    <span class="activity"><i class="icon-time"></i> Joined: <?php echo date("jS M Y",strtotime("".$dj."")); ?></span>

			
        <p>&nbsp;</p>
		
	<?php
		if(isset($_POST['s_PPic'])){
					$ifile1=$_FILES['u_PPic']['name']; 
					
						$ifile_tmp1=$_FILES['u_PPic']['tmp_name'];
						move_uploaded_file($ifile_tmp1,"../../members/photos/$ifile1");
					...
					$qry = "update members set picture='$ifile1' where id='$mem_id'";
					...
					$qryutl = "insert into user_timeline (user_id, activity) values ('$mem_id', '<b>$f_name</b> updated $pronoun profile picture.')";						
		...
		if(isset($_POST['updateProfile'])){
					...
					$mmstat = $_POST['mstat'];
					$ccity = $_POST['city'];
					$ccount = $_POST['country'];
					$rreli = $_POST['reli'];
					$uusern = $_POST['usern'];
					
					$qry = "update members set f_name='$fnamme', m_name='$mnamme', l_name='$lnamme', bio='$bbio', b_day='$ddob', m_status='$mmstat', city='$ccity', country='$ccount', religion='$rreli', username='$uusern' where id='$mem_id'";
					$run = mysqli_query($con, $qry);
					...
					$qryutl = "insert into user_timeline (user_id, activity) values ('$mem_id', '<b>$f_name</b> updated $pronoun profile Info.')";						
					$runutl = mysqli_query($con, $qryutl);
		...
		if(isset($_POST['updatePassword'])){
					...
					if($oldP == $psw){
						$qry = "update members set password='$newP' where id='$mem_id'";
						$run = mysqli_query($con, $qry);
						...
						echo "<script>alert('Error! Please provide a correct password')</script>";
					}
    ...
    <div class="row">
        <div id="item-header-avatar" class="eight columns image-hover">
            <img src="../../members/photos/<?php echo $pic; ?>" class="avatar user-45442-avatar avatar-580 photo" style="width: 250px; height: 250px;" alt="Profile picture of <?php echo $f_name." ".$m_name." ".$l_name; ?>" />
			<form action="" method="post" enctype="multipart/form-data">
				<input type="file" name="u_PPic">
				<hr>
				<input class="radius button danger" type="submit" value="Update profile picture" name="s_PPic">
			</form>
        </div>
...
<dt class="bp-field-name bp-field-id-1">First Name</dt>
<dd class="bp-field-value bp-field-id-1" style="padding: 0px;">
	<p>		
		<input type="text" name="fname" style="width: 100%; background: grey; color: white;" value="<?php echo $f_name; ?>" />
	</p>
</dd>
<dt class="bp-field-name bp-field-id-1">Middle Name</dt>
<dd class="bp-field-value bp-field-id-1" style="padding: 0px;">
	<p>		
		<input type="text" name="mname" style="width: 100%; background: grey; color: white;" value="<?php echo $m_name; ?>" />
	</p>
</dd>
<dt class="bp-field-name bp-field-id-1">Last Name</dt>
<dd class="bp-field-value bp-field-id-1" style="padding: 0px;">
	<p>		
		<input type="text" name="lname" style="width: 100%; background: grey; color: white;" value="<?php echo $l_name; ?>" />
	</p>
</dd>

<dt class="bp-field-name bp-field-id-3">Bio</dt>
<dd class="bp-field-value bp-field-id-3" style="padding: 0px;">
	<p>
		<textarea name="bio" style="width: 100%; background: grey; color: white;"><?php echo $bio; ?></textarea>
	</p>
</dd>

<dt class="bp-field-name bp-field-id-3">I am a</dt>
<dd class="bp-field-value bp-field-id-3">
	<p>
		<a href="#" rel="nofollow"><?php echo $gender; ?></a>
	</p>
</dd>

<dt class="bp-field-name bp-field-id-6">Looking for a</dt>
<dd class="bp-field-value bp-field-id-6">
	<p>
		<a href="#" rel="nofollow"><?php echo $l_for; ?></a>
	</p>
</dd>

<dt class="bp-field-name bp-field-id-2">Birthday</dt>
<dd class="bp-field-value bp-field-id-2" style="padding: 0px;">
	<p>
		<input type="date" name="dob" style="width: 100%; background: grey; color: white;" value="<?php echo $bday; ?>" />
	</p>
</dd>
<dt class="bp-field-name bp-field-id-9">Marital status</dt>
<dd class="bp-field-value bp-field-id-9" style="padding: 0px;">
	<p>
			<select name="mstat" style="width: 100%; background: grey; color: white;">
				<option value="<?php echo $m_stat; ?>"><?php echo $m_stat; ?></option>
...
<dt class="bp-field-name bp-field-id-17">City (Residence)</dt>
<dd class="bp-field-value bp-field-id-17" style="padding: 0px;">
	<p>
		<input type="text" name="city" style="width: 100%; background: grey; color: white;" value="<?php echo $city; ?>" />
	</p>
</dd>

<dt class="bp-field-name bp-field-id-18">Country (Residence)</dt>
<dd class="bp-field-value bp-field-id-18" style="padding: 0px;">
	<p>
			<select id="" name="country" style="width: 100%; background: grey; color: white;" >
...
<dt class="bp-field-name bp-field-id-18">Nationality</dt>
<dd class="bp-field-value bp-field-id-18">
	<p>
		<?php echo $nat; ?>
	</p>
</dd>

<dt class="bp-field-name bp-field-id-18">Religion</dt>
<dd class="bp-field-value bp-field-id-18" style="padding: 0px;">
	<p>
			<input type="text" name="reli" style="width: 100%; background: grey; color: white;" value="<?php echo $religion; ?>" />
	</p>
</dd>

<dt class="bp-field-name bp-field-id-18">Username</dt>
<dd class="bp-field-value bp-field-id-18" style="padding: 0px;">
	<p>
			<input type="text" name="usern" style="width: 100%; background: grey; color: white;" value="<?php echo $usn; ?>" />
			<input class="radius button danger" type="submit" name="updateProfile" style="width: 100%;" value="Update" />
	</p>
</dd>
</form>
<hr>
<dt class="bp-field-name bp-field-id-18">Change Password</dt>
<dd class="bp-field-value bp-field-id-18" style="padding: 0px;">
	<p>
		<form action="" method="post">
			<i style="padding-left: 5px;">Enter old password</i>
			<input type="password" name="oldPass" style="width: 100%; background: grey; color: white;" required />
			<i style="padding-left: 5px;">Enter new password</i>
			<input type="password" name="newPass" style="width: 100%; background: grey; color: white;" required />
			<input class="radius button danger" type="submit" name="updatePassword" value="Change Password" />
		</form>
	</p>
</dd></dl></li>
	...
	<div id="item-nav">
		<div class="item-list-tabs no-ajax" id="object-nav" aria-label="Member primary navigation" role="navigation">
			<ul>
				...
				<li><a id="user-friends" href="../../members/index.php?user=<?php echo $mem_id; ?>">My Friends <span class="no-count">
					<?php
								$sqlfrlist = "select * from friends where m_id='$mem_id'"; 
				...
				<li id="friends-personal-li" ><a id="user-friends" href="../../forum/index.php?g_mem=<?php echo $mem_id; ?>">My Groups <span class="no-count">
					<?php
									$sqlgrp = "select * from group_members where m_id='$mem_id' and status='1'"; 
				...
				<li id="friends-personal-li" ><a id="user-friends" href="../../forum/my_groups.php">My Created Groups <span class="no-count">
					<?php
									$sqlmygrp = "select * from groups where g_admin='$mem_id'"; 
									$resmygrp=mysqli_query($con,$sqlmygrp);
									$countmygrp = mysqli_num_rows($resmygrp); 
									echo $countmygrp;
								?>
				</span></a></li>
				
				<li id="friends-personal-li" ><a id="user-friends" href="http://localhost:140/dating/contact/index.php#testimonial">Write a testimonial</a></li>
...
<div class="activity" aria-live="polite" aria-atomic="true" aria-relevant="all">
		...
		<ul id="activity-stream" class="activity-list item-list">
			...
			<?php 
				$act_sql = "SELECT * FROM user_timeline where user_id='$mem_id' order by 1 desc";
											$act_run = mysqli_query($con, $act_sql);
											while($row = mysqli_fetch_array($act_run)){
												$act_id=$row['id'];
												$act_user=$row['user_id'];
												$act_=$row['activity'];
												$act_date=$row['date'];
												
												echo "
													<li class='xprofile updated_profile activity-item mini' id='activity-7659'>
														<div class='activity-avatar'>
															<a href='index.php'>
																<img src='../../members/photos/$pic' class='avatar user-45442-avatar avatar-120 photo' alt='Profile picture of $f_name $m_name $l_name' />
															</a>
														</div>

														<div class='activity-content'>
															<div class='activity-header'>
																<p> $act_ - <a href='#' class='view activity-time-since bp-tooltip' ><span class='time-since'>".date("jS M Y h:i:s",strtotime("".$act_date.""))."</span></a></p>
															</div>
														</div>
													</li>
												";
