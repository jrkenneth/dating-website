...
<small><i class='icon-lock'></i> Your <a href='#'>privacy</a> is important to us and we will never rent or sell your information.</small></strong></div>
		...
		if(isset($_GET['gid'])){
			$select_gr = $_GET['gid'];
			$_SESSION['ggggreoupid'] = $select_gr;
...
(function($)
{
    $(document).ready(function()
    {
        ...
        $container.load("getComments.php");
...
var usser = $("#uid").val();
var grroup = $("#group").val();
// Returns successful data submission message when the entered information is stored in database.

var dataString = 'comm1='+ comment + '&user1='+ usser + '&group1='+ grroup;
					...
					<div id="breadcrumbs-wrapp">
						<div class="row">
							<div class="nine columns">
								<ul class="breadcrumbs hide-for-small"><li><a href="../../index.php" title="Sweet Date" rel="home" class="trail-begin">Home</a>  </li><li><a href="../index.php" title="Groups">Group Forums</a>  </li><li><a href="#" title="<?php echo $gr_name; ?>"><?php echo $gr_name; ?></a></li></ul>							</div>
...
<div id="cover-image-container">
	...
	<div id="item-header-cover-image">
		...
		<div id="item-actions">
				...
				<a href="forum_thread.php?gid=<?php echo $gr_id; ?>">
		...
		<div id="item-header-content">
			<h2><a href="forum_thread.php?gid=<?php echo $gr_id; ?>" title="<?php echo $gr_name; ?>"><?php echo $gr_name; ?></a></h2>
	...
	<div id="item-nav">
		<div class="item-list-tabs no-ajax" id="object-nav" aria-label="Group primary navigation" role="navigation">
			<ul>
				...
				<li id="home-groups-li"><a id="home" href="index.php?gid=<?php echo $gr_id; ?>">Activity</a></li>
				<li id="members-groups-li" ><a id="members" href="../../members/index.php?group=<?php echo $gr_id; ?>">Group Members <span>
					<?php echo $countgrm; ?>
				</span></a></li>
				<li id="members-groups-li"  class="current selected" ><a id="members" href="forum_thread.php?gid=<?php echo $gr_id; ?>">Forum Thread</a></li>
...
<div class=" single-group" aria-live="polite" aria-atomic="true" aria-relevant="all">
		...
		<div id="content" style="max-height: 650px; overflow: auto;"></div>
...
<li class="groups joined_group activity-item mini date-recorded-1443486963" id="activity-4575">
	<div class="" style="padding-left: 5px;">
		<form id="myForm">
			...
			<input type="hidden" id="uid" value="<?php echo $smem_id; ?>">
			<input type="hidden" id="group" value="<?php echo $gr_id; ?>">
